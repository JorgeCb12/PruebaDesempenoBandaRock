...
This project is a responsive landing page for a rock band.
...
├── pages/
│   └── section.html    # Additional page sections
...
- Unordered list (ul) for band experiences
- Multimedia gallery using CSS Grid
...
The page will open in your default browser with live reloading.
...
- **Hero:** Main visual section with CTA
- **Events:** Festival dates and structured table
- **About:** Description and experiences
- **Zones:** Food areas using cards (Flex/Grid)
- **Gallery:** Image grid
